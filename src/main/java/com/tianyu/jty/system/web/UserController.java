...
public class UserController extends BaseController {
	...
	@ResponseBody
	public User getUserById(HttpServletRequest request,@PathVariable("id") Integer id){
		//if id = 0 return my profile
		return  id == 0 ? userService.getUser(request.getRemoteUser()):userService.get(id);
	}
